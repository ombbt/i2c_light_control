...
void name_enchainement1(int count1, int time2, int time3){
  ...
  if(name_enchainement1_status == 2){
    name_fade1(vert, gris, 3000, offset_list4);
...
void mode0() {
 ...
 // Serial.print(" efecton ");
  ...
  switch(namestatus){  
      ...
      case 1:
        top_colors3(blanc, blanc, blanc, 500, 500, 500);
        bot_colors3(blanc, blanc, blanc, 500, 500, 500);
      
       // if(timespend < 20 and efecton == 0){
       // name_fade1_init = 0;
       // }
       // name_fade1(bleu, jaune, 6000, offset_list4); //config sympa a garder
       // name_enchainement1(3, 600, 4000);
      break;
      
      case 2:
      
      name_chenillarblanc(100);
        //name_fixed1(bleu, jaune, rouge, rose, violet, bleu, jaune, rouge, rose, violet, bleu, jaune, rouge, rose, violet, bleu, jaune, rouge, rose, violet, vert, blanc);
      break;
