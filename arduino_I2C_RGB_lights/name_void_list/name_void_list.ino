...
unsigned long name_THEblink_timmer; //idem THE ONE MAN BIG
...
unsigned long name_THEchenillar1_timmer;  //idem THE ONE MAN BIG chennillar 1 2 3 disponible
...
unsigned long name_BANDchenillar2_timmer;   //chenillar 1 2 3 disponible
...
unsigned long name_THEORYchenillar1_timmer;   //chenillar 1 2 3 4 5 dispo
